...
class UserInfoSchemaBase(SchemaBase):
    ...
    birth_date: datetime | None = Field(default="2025-01-24 13:35:42", description="出生日期")
...
class UserInfoDetail(UserInfoSchemaBase, _VerifyPhone):
    ...
    join_time: datetime | None = Field(default="2025-01-24 13:35:42", description="注册时间")
    last_login_time: datetime | None = Field(default="2025-01-24 13:35:42", description="上次登录时间")
    updated_username_time: datetime | None = Field(default="2025-01-24 13:35:42", description="上次更新用户名的时间")
